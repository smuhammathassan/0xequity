...
//     function updateBuySpotDifference(
//         uint256 _newDifference
//     ) external onlyComdexAdmin {
//         //maximum allowed value for difference is 10% could be as low as 0 (1000 = 10.00 %)
//         require(_newDifference <= 1000, "BP: invalid spot difference");
...
//     function updateSellSpotDifference(
//         uint256 _newDifference
//     ) external onlyComdexAdmin {
//         //maximum allowed value for difference is 10% could be as low as 0 (1000 = 10.00 %)
//         require(_newDifference <= 1000, "BP: invalid spot difference");
