...
//         uint256 commodityUnitPriceStable = _convertUSDToStable(
//             commodityUnitPriceUsd
//         );
...
//                 commodityUnitPriceStable +
//                 ((commodityUnitPriceStable * dexSettings.buySpotDifference) /
//                     10000); // adding % from spot price
...
//             uint256 stableAmount = (_amountIn * commodityUnitPriceStable) /
...
//     function _isCommodityFeedTimeout(
//         uint256 _updatedAt
