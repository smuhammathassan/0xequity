...
contract StakingManager2 is Ownable {
    ...
    function deposit(uint256 _poolId, uint256 _amount) external {
        ...
        // Update pool stakers
        harvestRewards(_poolId, "deposit");
        ...
        staker.rewardDebt =
            ...
            REWARDS_PRECISION;
        console.log("Deposit:reward Debt is ", staker.rewardDebt);
        // Update pool
    ...
    function withdraw(uint256 _poolId) external {
        ...
        // Pay rewards
        harvestRewards(_poolId, "withdraw");
        ...
        console.log("Withdraw:reward Debt is ", staker.rewardDebt);
        // Update pool
     ...
     */
    function harvestRewards(uint256 _poolId, string memory _sender) public {
        ...
        if (rewardsToHarvest == 0) {
            console.log("Reward to harvest is zero");
            staker.rewardDebt =
                (staker.amount * pool.accumulatedRewardsPerShare) /
                REWARDS_PRECISION;
            return;
        ...
        console.log("Harvest:", _sender, ":reward Debt is ", staker.rewardDebt);
